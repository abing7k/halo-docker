...
CMD [ "--spring.config.location=classpath:/application.yaml,file:./application.yaml" ,"--halo.security.initializer.superadminusername=hanbing" ,"--halo.security.initializer.superadminpassword=Hb742608." ,"--spring.r2dbc.url=r2dbc:pool:mysql://47.99.49.255:3307/blog","--spring.r2dbc.username=blog" ,"--spring.r2dbc.password=hb742608.","--spring.sql.init.platform=mysql"]